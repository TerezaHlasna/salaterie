...
class Bar
{
	...
	public function renderLoader(): void
	{
		...
		$async = true;
		require \ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.7.x/src/Tracy/Bar' . '/assets/loader.phtml';
	}
	...
	private function renderHtml(string $type, string $suffix = ''): array
	{
		...
		return [
			'bar' => Helpers::fixEncoding(Helpers::capture(function () use ($type, $panels) {
				require \ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.7.x/src/Tracy/Bar' . '/assets/bar.phtml';
			})),
			'panels' => Helpers::fixEncoding(Helpers::capture(function () use ($type, $panels) {
				require \ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.7.x/src/Tracy/Bar' . '/assets/panels.phtml';
			})),
		];
	}
	...
	private function renderAssets(): void
	{
		$css = array_map('file_get_contents', array_merge([
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.7.x/src/Tracy/Bar' . '/assets/bar.css',
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.7.x/src/Tracy/Bar' . '/../Toggle/toggle.css',
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.7.x/src/Tracy/Bar' . '/../TableSort/table-sort.css',
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.7.x/src/Tracy/Bar' . '/../Dumper/assets/dumper.css',
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.7.x/src/Tracy/Bar' . '/../BlueScreen/assets/bluescreen.css',
...
();\n";
		...
		array_map('readfile', array_merge([
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.7.x/src/Tracy/Bar' . '/assets/bar.js',
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.7.x/src/Tracy/Bar' . '/../Toggle/toggle.js',
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.7.x/src/Tracy/Bar' . '/../TableSort/table-sort.js',
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.7.x/src/Tracy/Bar' . '/../Dumper/assets/dumper.js',
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.7.x/src/Tracy/Bar' . '/../BlueScreen/assets/bluescreen.js',
